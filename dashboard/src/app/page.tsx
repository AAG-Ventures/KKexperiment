...
import { DraggableOverviewContainer } from './components/DraggableOverviewContainer';
import { DraggableCalendarWidget } from './components/DraggableCalendarWidget';
import { DraggableTasksWidget } from './components/DraggableTasksWidget';
import { DraggableRecentActivityWidget } from './components/DraggableRecentActivityWidget';
            ...
            <>
              ...
              <DraggableOverviewContainer
                widgets={[
                  ...
                  {
                    id: 'recent-activity',
                    content: <DraggableRecentActivityWidget id="recent-activity" />
                  },
                  {
                    id: 'tasks',
                    content: (
                      <DraggableTasksWidget 
                        id="tasks"
                        tasks={tasks}
                        ...
                        onTaskDeadlineChange={setNewTaskDeadline}
                        ...
                        onShowPrioritySelector={() => setShowPrioritySelector(true)}
                        onHidePrioritySelector={() => setShowPrioritySelector(false)}
                        formatDeadline={formatDeadline}
                        isDeadlineUrgent={isDeadlineUrgent}
                        isDeadlineSoon={isDeadlineSoon}
                        isDeadlineNormal={isDeadlineNormal}
                      />
                    )
                  }
                ]}
