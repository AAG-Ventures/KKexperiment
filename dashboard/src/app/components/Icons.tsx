// Icons.tsx - Modern SVG Icon Components
// Using simplified SVG paths based on Heroicons (https://heroicons.com/) - MIT Licensed
...
export const BellIcon: React.FC<IconProps> = ({ className, size = 20 }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="var(--foreground-primary)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9" data-component-name="BellIcon" />
